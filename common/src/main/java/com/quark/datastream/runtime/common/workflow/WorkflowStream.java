...
public class WorkflowStream extends Format {
	...
	public void setFieldsStr(String fields) {
		try {
			...
			this.fields = mapper.readValue(fields, new TypeReference<List<Field>>() {
			});
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public enum SchemaType {
		BOOLEAN(Boolean.class), BYTE(Byte.class), SHORT(Short.class), INTEGER(Integer.class), LONG(Long.class), FLOAT(
				Float.class), DOUBLE(Double.class), STRING(String.class), BINARY(
						byte[].class), NESTED(Map.class), ARRAY(List.class), BLOB(InputStream.class);
