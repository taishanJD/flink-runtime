...
public class DataSetTest {
  ...
  public void testComplexBatchData() {
    ...
    System.out.println(dataSet.getValue("/records/name", List.class));
    ...
    for (DataSet.Record record : dataSet.getRecords()) {
      for(String key : record.keySet()){
        ...
        System.out.println("record 中的key、value " +key+ "：" +o);
      }
  ...
  public void testJsonStr(){
    ...
    dataSet.addRecord("{\n" +
            "\t\"data\": [{\n" +
            "\t\t\"product_id\": \"3001\",\n" +
            "\t\t\"device_id\": \"1000202004\",\n" +
            "\t\t\"cloud_time\": \"2017-09-06 19:08:11.211\",\n" +
            "\t\t\"datapoint_1\": \"2017-09-06 19:08:11\",\n" +
            "\t\t\"datapoint_2\": 2.01,\n" +
            "\t\t\"datapoint_3\": \"2017-09-06 18:08:12\",\n" +
            "\t\t\"datapoint_4\": 100,\n" +
            "\t\t\"datapoint_5\": 1.01,\n" +
            "\t\t\"datapoint_6\": 0,\n" +
            "\t\t\"datapoint_7\": 40.0454,\n" +
            "\t\t\"datapoint_8\": \"2017-09-06 09:08:10\",\n" +
            "\t\t\"datapoint_9\": 116.2747,\n" +
            "\t\t\"datapoint_10\": 120\n" +
            "\t}, {\n" +
            "\t\t\"product_id\": \"3001\",\n" +
            "\t\t\"device_id\": \"1000202004\",\n" +
            "\t\t\"cloud_time\": \"2017-09-06 19:08:11.387\",\n" +
            "\t\t\"datapoint_3\": 110,\n" +
            "\t\t\"datapoint_4\": 100,\n" +
            "\t\t\"datapoint_5\": 1.01,\n" +
            "\t\t\"datapoint_6\": 1,\n" +
            "\t\t\"datapoint_9\": 40.0454,\n" +
            "\t\t\"datapoint_10\": 116.2747\n" +
            "\t}]\n" +
            "}");

    System.out.println(dataSet);

    List value = dataSet.getValue("/records/data/product_id", List.class);
    System.out.println(value);
  }

  @Test
  public void testJsonStr2(){
    DataSet dataSet = DataSet.create();
    dataSet.addRecord("[{\n" +
            "\t\t\"product_id\": \"3001\",\n" +
            "\t\t\"device_id\": \"1000202004\",\n" +
  ...
  public void testJsonStr3(){
    ...
    String value = dataSet.getValue("/records/data/datapoint_10/dt_10_2", String.class);
    System.out.println(value);
  }
  ...
  public void testGetValue() {
    ...
    DataSet.Record streamedRecord = dataSet.getStreamedRecord();
