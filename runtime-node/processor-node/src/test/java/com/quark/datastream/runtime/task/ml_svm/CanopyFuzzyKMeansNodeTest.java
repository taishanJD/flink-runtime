...
public class CanopyFuzzyKMeansNodeTest {

    @Test
    public void CanopyFuzzyKMeansNodeTest() {
        ...
        paramMap.put("runClustering", true);
        ...
        CanopyFuzzyKMeansNode fuzzyKMeansNode = new CanopyFuzzyKMeansNode();
