...
public class CanopyKMeansNodeTest {

    @Test
    public void CanopyKMeansNodeTest() {
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("inputKeys", "test1,test2,test3,test4");
        paramMap.put("resultKey", "result");
        paramMap.put("t1", 2.0D);
        paramMap.put("t2", 1.0D);
        ...
        CanopyKMeansNode canopyNode = new CanopyKMeansNode();
        canopyNode.setParam(param);
        ...
        canopyNode.calculate(in, new ArrayList<>(), new ArrayList<>());
        DataSet dataSet = canopyNode.calculate(in, new ArrayList<>(), new ArrayList<>());
